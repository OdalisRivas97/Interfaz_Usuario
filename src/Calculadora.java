...
String Numero2;
    ...
    private void initComponents() {
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(500, 116));
...
if(!Numero2.equals("")){
    Igual=Aritmetica(Numero1,Signo,Numero2);
    Pantalla.setText(Igual);
}
    }//GEN-LAST:event_jButton12ActionPerformed
public static boolean ExistePunto(String lista){
    boolean resultado;
    resultado = false;
    
    for (int i=0;i<lista.length();i++){
    if (lista.substring(i,i+1).equals(".")){
        resultado=true;
        break;
    }
}
...
public static String Aritmetica(String Numero1, String Signo, String Numero2){
    Double Igual=0.0;
    String Resultado;
    
    if (Signo.equals("/")){
        Igual=Double.parseDouble(Numero1)/Double.parseDouble(Numero2);
    }
